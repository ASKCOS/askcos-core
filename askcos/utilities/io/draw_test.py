...
class TestDraw(unittest.TestCase):
    ...
    def test_01_ReactionStringToImage(self):
        ...
        expected = Image.open(os.path.join(os.path.dirname(__file__), 'test_data/draw_test_rxn_string.png'))
    ...
    def test_02_ReactionStringToImageRetro(self):
        ...
        expected = Image.open(os.path.join(os.path.dirname(__file__), 'test_data/draw_retro_test_rxn_string.png'))
        self.assertIsNone(ImageChops.difference(result, expected).getbbox())
    ...
    def test_03_TransformStringToImage(self):
        ...
        expected = Image.open(os.path.join(os.path.dirname(__file__), 'test_data/draw_transform.png'))
        self.assertIsNone(ImageChops.difference(result, expected).getbbox())
