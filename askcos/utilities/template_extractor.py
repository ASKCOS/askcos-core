...
def extract_from_reaction(reaction):
    ...
    try:
        ...
        reactant_fragments, intra_only, dimer_only, reactants_original = get_fragments_for_changed_atoms(reactants, changed_atom_tags,
        ...
        product_fragments, _, _, products_original  = get_fragments_for_changed_atoms(products, changed_atom_tags,
