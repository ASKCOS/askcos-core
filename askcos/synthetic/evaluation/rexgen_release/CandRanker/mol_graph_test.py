...
import askcos.synthetic.evaluation.rexgen_release.CandRanker.mol_graph as mg
...
class TestCRMolGraph(unittest.TestCase):
    ...
    def test_01_smiles2graph(self):
        """Test askcos.synthetic.evaluation.rexgen_release.CandRanker.mol_graph.smiles2graph"""
