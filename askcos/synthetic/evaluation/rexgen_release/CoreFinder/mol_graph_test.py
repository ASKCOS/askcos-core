...
import askcos.synthetic.evaluation.rexgen_release.CoreFinder.mol_graph as mg


class TestCFMolGraph(unittest.TestCase):

    def test_01_smiles2graph_batch(self):
        """Test askcos.synthetic.evaluation.rexgen_release.CoreFinder.mol_graph.smiles2graph_batch"""
